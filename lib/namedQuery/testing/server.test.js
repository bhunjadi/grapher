...
describe('Named Query', function () {
    ...
    it('Should work with foreign field - regular link assembly', () => {
        const res = productAttributesList.clone({}).fetch();
    ...
    it('Should work with foreign field - inversed link assembly', () => {
        const res = productsList.clone({}).fetch();
