...
describe("Collection Links", function() {
    ...
    describe('foreignField linkConfig param', function () {
        beforeEach(function () {
        ...
        it("Works with foreign field - many", function () {
            ...
            const link = ReferenceCollection.getLink({scdId: '1'}, "scds");
            // both SCDs should be found since they share originalId
            assert.lengthOf(link.find().fetch(), 2);
        ...
        it("Auto-removes for foreign field - one", function () {
            ...
            // todo: not working - the other autoremove link (on scdId field) removes all of the docs
            // because linker.find() searches by {scdId: undefined}
