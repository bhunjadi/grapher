...
import { difference, isObject } from '../../utils.js';
...
export default class Link {
  ...
  constructor(linker, object, collection) {
    ...
    /** @type {string} */
    this.linkStorageField = this.linker.isVirtual()
      ? this.config.relatedLinker?.linkConfig.field
      : this.config.field;
  }
  ...
  find(filters = {}, options = {}, userId = undefined) {
     ...
     */
    let appliedFilters = Object.assign({}, filters, searchFilters);
