...
export default class Linker {
    ...
    constructor(mainCollection, linkName, linkConfig) {
        ...
        if (this.isVirtual()) {
            ...
            if (!linkConfig.autoremove && linkConfig.removeReference) {
    ...
    _initDenormalization() {
        ...
        const { field, body, updateOptions, bypassSchema } = this.linkConfig.denormalize;
        let cacheConfig;
        ...
        if (updateOptions) {
            cacheConfig.updateOptions = updateOptions;
        }
        if (bypassSchema === true) {
            cacheConfig.updateOptions = {
                ...cacheConfig.updateOptions,
