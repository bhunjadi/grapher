...
export default class Linker {
  ...
  isDenormalized() {
    if (this.isVirtual()) {
      return !!this.linkConfig.relatedLinker?.linkConfig?.denormalize;
    }
  ...
  isSubBodyDenormalized(body) {
    const denormBody = this.isVirtual()
      ? this.linkConfig.relatedLinker?.linkConfig?.denormalize?.body
      : this.linkConfig.denormalize?.body;
