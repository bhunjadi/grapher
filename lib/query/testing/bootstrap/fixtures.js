...
const project1 = await Projects.insertAsync({name: 'Project 1', projectValue: 10000});
const project2 = await Projects.insertAsync({name: 'Project 2', projectValue: 20000, private: true});
