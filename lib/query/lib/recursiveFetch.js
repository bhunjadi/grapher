...
import assemble from '../hypernova/assembler.js';
...
function fetch(node, parentObject, fetchOptions = {}) {
    ...
    _.each(node.collectionNodes, collectionNode => {
        _.each(results, result => {
            ...
            // this was not working because all references must be replaced in snapBackCaches, not only first found
            // which is the case when filtering
